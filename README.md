...
- Unter **Attraktion → Ein- & Ausgangspods → Platzsparender Zugang → Gemeinsam** teilen sich Einlass und Ausstieg einen Pod und einen Weg. Die Umstellung ist kostenlos und möglich, sobald die Anlage und ihr Zugang leer sind. Bei laufendem Betrieb kannst du sie dafür direkt schließen.
- Verbinde den Pod mit einem **blauen Eingangsweg**. Dieser erscheint automatisch halb blau, halb rot: Gäste warten auf der blauen Hälfte und verlassen die Attraktion über die rote. Erst wenn alle Aussteiger den öffentlichen Parkweg erreicht haben, beginnt der nächste Einlass. Die blaue Hälfte bietet zwei Warteplätze je Feld; Spuren und Schranken sind auch in 3D sichtbar.
- **Getrennt** stellt die vorherigen beiden Podpositionen wieder her. Alte rote Wege bleiben beim Zusammenlegen bestehen und können für mehr Platz abgerissen werden. Einstellung und laufende Ausstiege werden gespeichert; Umbauten lassen sich rückgängig machen, sobald keine Gäste mehr betroffen sind.
- Das **Riesenrad** hält jede seiner acht Gondeln einzeln an der Plattform zum Beladen an und rückt danach weiter. Sobald die Warteschlange leer oder das Rad voll ist, folgen die eingestellten Runden; anschließend werden die besetzten Gondeln einzeln entladen. Die Betriebsanzeige zeigt Phase, Belegung und die aktuelle Gondel. Parkansicht und 3D verwenden dieselben Gondelplätze; beim Speichern bleiben Belegung und Bewegung erhalten.
...
- **Bild oder Namen einer Person anklicken** zentriert die Parkkamera auf sie und markiert sie kurz mit Namen und aktuellem Auftrag. Qualifikation und Zuweisung lassen sich darunter getrennt aufklappen. Das funktioniert auch in der Tierpflegeübersicht.
- Reinigung und Tierpflege laufen auf erreichbaren Wegen zu Aufträgen und gehen sonst Kontrollrunden. Reinigungskräfte kehren Müll zusammen, tragen ihn zur Tonne, wechseln volle Beutel und bringen diese zur Sammelstelle. Ohne erreichbare Tonne nutzen sie eine erreichbare Sammelstelle. Müll bleibt während des Transports Teil der Simulation.
- Fahrgeschäft-Crews werden aus dem vorhandenen Personalbestand automatisch verteilt. Offene, getestete Anlagen haben Vorrang; freie Teams können sonst bereits neue Anlagen vorbereiten. Automatische Teams wechseln bei Bedarf von geschlossenen Anlagen, sobald keine Fahrt oder Ausstiegsphase mehr läuft. Neue Anlagen stellen niemanden ungefragt ein.
- In **Verwalten → Personal** kannst du Crews einstellen, freigeben, entlassen und per Anlagenkarte gezielt zuweisen. Eine direkte Zuweisung bindet das Team fest; **Feste Bindung lösen** schaltet es wieder für die Automatik frei. **Automatik aus** hält eine einzelne Anlage frei. Freigegebene Teams bleiben angestellt und verursachen weiterhin den ausgewiesenen Crewlohn. Namen, Aussehen und Personenortung bleiben auch beim Anlagenwechsel erhalten.
- Mitarbeiter besitzen gemeinsame Gelenk- und Arbeitsanimationen in Parkansicht und 3D: Schritte und Arme, Besenführung, Beutelübergabe und Tonnendeckel, Füttern, Wasserversorgung und Kontrolle. Fahrgeschäft-Crews haben drei feste Arbeitsplätze: Die Bedienung arbeitet am Pult im einsehbaren Steuerhaus; der Einlass prüft Tickets und öffnet die Schranke; der Ausstieg begleitet tatsächlich aussteigende Gäste. Die Torposten treten passend zum Arbeitsablauf vor und zurück. Tore bleiben beim Aussteigen offen, bis die Gäste den Ausgang passiert haben. Kabine, Personalpositionen und Torzustand stammen in 2D und 3D aus derselben Spielinformation. Die Kabine wird gemeinsam mit dem Fahrgeschäft gebaut und folgt versetzten Pods automatisch; sie benötigt keinen separaten Bauauftrag. Die Animationsregel für zukünftige Figuren steht in [AGENTS.md](AGENTS.md).
