...
Eine Achterbahn kannst du im **Schnellbau** vollständig platzieren und mit **R** drehen. Ihre Testfahrt startet automatisch; nach dem Anschluss eröffnet sie sich, sobald der Test abgeschlossen ist. Unter **Bauteile** setzt du eine Station und wählst Geraden, Steigungen, Abfahrten, Kurven oder Loopings. Die grüne/rote Vorschau zeigt das nächste Teil, bevor du **Anfügen** drückst oder auf die Karte klickst. Jedes Teil passt seine Richtung und Höhe automatisch an den letzten Anschluss an. **Zur Station verbinden** sucht einen freien, geschlossenen Rückweg; **Letztes Bauteil entfernen** und Strg/⌘ Z entfernen jeweils einen vollständigen Bauschritt. Holzbahnen bleiben ohne Inversionen und sind auf 20 m begrenzt, Stahl-/Launch-Bahnen auf 40 m. **3D-Mitfahren** im Bahnfenster öffnet eine unabhängige Probefahrt.

**Einzelne Gleise entfernen:** Bahn auswählen → **Gleisabschnitte bearbeiten**. Schiene anklicken (Shift erweitert den Bereich) oder Von/Bis auswählen. Die rot markierten Teile entfernen; danach neue Bauteile oder einen Looping anfügen und **Offene Enden verbinden**. Die Suche berücksichtigt erhaltene Gleise, Richtung, Höhe, Hindernisse und den verfügbaren Platz. Bei einem zu engen Schnitt einen größeren Bereich entfernen. Türkis markiert den erhaltenen Anschluss. **Umbau übernehmen** berechnet nur Ersatzmaterial abzüglich Recycling; danach erneut testen und eröffnen. Unfertige Baustellen werden gespeichert und bleiben geschlossen. **Umbau abbrechen** stellt die ursprüngliche Strecke wieder her.
